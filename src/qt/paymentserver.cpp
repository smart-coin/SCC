...
const char* BIP71_MIMETYPE_PAYMENT = "application/smartcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/smartcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/smartcoin-paymentrequest";
