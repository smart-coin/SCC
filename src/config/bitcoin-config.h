...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SmartCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SmartCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/smart-coin/SCC/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SmartCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SmartCoin Core 0.14.2"
