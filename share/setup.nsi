...
VIAddVersionKey ProductName "SmartCoin Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\smartcoin-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\SmartCoin Core (testnet, -bit).lnk" "$INSTDIR\smartcoin-qt" "-testnet" "$INSTDIR\smartcoin-qt" 1
    ...
    WriteRegStr HKCR "smartcoin" "URL Protocol" ""
    WriteRegStr HKCR "smartcoin" "" "URL:SmartCoin"
    WriteRegStr HKCR "smartcoin\DefaultIcon" "" $INSTDIR\smartcoin-qt
    WriteRegStr HKCR "smartcoin\shell\open\command" "" '"$INSTDIR\smartcoin-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\smartcoin-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\SmartCoin Core (testnet, -bit).lnk"
