...
ACLOCAL = ${SHELL} /smartcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /smartcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /smartcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /smartcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /smartcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_URL = https://www.smart-coin.io/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /smartcoin
abs_srcdir = /smartcoin
abs_top_builddir = /smartcoin
abs_top_srcdir = /smartcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /smartcoin/build-aux/install-sh
